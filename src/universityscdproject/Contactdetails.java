...
public class Contactdetails extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Contactdetails.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel8.setText("0301-1111111");

        jLabel9.setText("Haider1@gmail.com");

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/contact.png"))); // NOI18N
    ...
    String message = jTextArea1.getText();   
     ...
     if(name.isEmpty() || email.isEmpty() || message.isEmpty()) {
        javax.swing.JOptionPane.showMessageDialog(this, "Please fill all fields before sending.");
        return;
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Contactdetails().setVisible(true));
    }
